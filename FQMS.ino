...
String mySSID = "NETWORK SSID";
String myPWD = "NETWORK PASSWORD";
String myAPI = "YOUR THINGSPEAK API KEY";
...
void loop() {
  ...
  String sendData = "GET /update?api_key=" + myAPI + "&" + mq3 + "=" + String(analog) + "&" + temp + "=" + String(temperature) + "&" + humid + "=" + String(humidity) + "&" + photons + "=" + String(light);
  ...
  boolean actualCondition = (alcoholDifference > 5 && light < 10 && (temperature < 20 || temperature > 35) && humidity > 52);
